...
ner = NerModel(model_name='../models/ner/new_ner_model.h5', proprocess=p)
query = []



query.append('김포에 있는 고려병원 전화번호 알려줘')
query.append('김포시에 있는 고려병원 정보 알려주세요')
query.append('안산시단원구 고잔동 내과 리스트')
query.append('안산시 단원구 내과 리스트')
query.append('안산시 고잔동 내과 리스트')

query.append('김포시 요양병원')
query.append('김포시 장기동 요양병원')
query.append('김포시 장기동 고려병원')
